...
export class ExperienceComponent implements OnInit {
  ...
  ngOnInit(): void {
    /* this.datosPortafolio.obtenerDatosExperience().subscribe(data => {
      console.log("CHE-EXPERIENCE JSON -Datos Personales: " + JSON.stringify(data));
      this.miPortafolio=data;
      this.myPortfolio=data;
    }) */
    this.datosPortafolio.getData().subscribe(data => {
      this.miPortafolio=data.experience;
      this.myPortfolio=data.experience;
      console.log("CHE-EXPERIENCE",this.myPortfolio);
    });
  }
